  ...
  return (
    <>
      ...
      <main className="page page--wide">
        ...
        <div className="row row--between" style={{ alignItems: 'flex-start', marginBottom: '1rem' }}>
          <div>
            ...
            <div className="row" style={{ gap: '0.4rem' }}>
              ...
              <span className="small muted">{quiz.questions.length} questions · {formatDuration(quiz.settings.durationSeconds)} · {quiz.settings.revealAnswers ? 'answers revealed' : 'answers hidden'}{quiz.settings.shuffleQuestions || quiz.settings.shuffleOptions ? ' · shuffled' : ''}</span>
            </div>
          </div>
          <div className="row">
        ...
        {tab === 'responses' && <ResponsesPanel quiz={quiz} version={entryCount} onGraded={() => void board.refresh()} />}
        {tab === 'leaderboard' && (
          <div className="stack">
